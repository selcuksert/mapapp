package com.corp.mapapp.medage.client;

import com.corp.mapapp.medage.model.Response;
...
public interface MedAgeAPI {
    @GET
    @Path("/indicators/{indicator}/locations/{location}")
    Uni<Response> getMedianAge(@PathParam("indicator") String indicator,
